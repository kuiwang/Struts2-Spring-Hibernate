...
public class RepairServiceImpl implements RepairServiceI {
    ...
    private void repairMenu() {
        ...
        menu1_1.setCurl("/equipAction!equip.action");
        ...
        menu1_2.setCurl("/docAction!doc.action");
        ...
        menu2_1.setCurl("/userAction!user.action");
        ...
        menu2_2.setCurl("/roleAction!role.action");
        ...
        menu2_3.setCurl("/authAction!auth.action");
        ...
        menu3_1.setCurl("/logAction!log.action");
        ...
        menu3_2.setCurl("/userAction!chart.action");
    ...
    private void repairAuth() {
        ...
        auth1_1.setCurl("/equipAction!datagrid.action");
        ...
        auth1_2.setCurl("/equipAction!equip.action");
        ...
        auth1_3.setCurl("/docAction!datagrid.action");
        ...
        auth1_4.setCurl("/docAction!doc.action");
        ...
        auth2_1.setCurl("/userAction!user.action");
        ...
        auth2_2.setCurl("/userAction!datagrid.action");
        ...
        auth2_3.setCurl("/userAction!userAdd.action");
        ...
        auth2_4.setCurl("/userAction!add.action");
        ...
        auth2_5.setCurl("/userAction!userEdit.action");
        ...
        auth2_6.setCurl("/userAction!edit.action");
        ...
        auth2_7.setCurl("/userAction!delete.action");
        ...
        auth2_8.setCurl("/userAction!userRoleEdit.action");
        ...
        auth2_9.setCurl("/userAction!roleEdit.action");
        ...
        auth3_1.setCurl("/roleAction!role.action");
        ...
        auth3_2.setCurl("/roleAction!datagrid.action");
        ...
        auth3_3.setCurl("/roleAction!roleAdd.action");
        ...
        auth3_4.setCurl("/roleAction!add.action");
        ...
        auth3_5.setCurl("/roleAction!roleEdit.action");
        ...
        auth3_6.setCurl("/roleAction!edit.action");
        ...
        auth3_7.setCurl("/roleAction!delete.action");
        ...
        auth4_1.setCurl("/authAction!auth.action");
        ...
        auth4_2.setCurl("/authAction!treegrid.action");
        ...
        auth4_3.setCurl("/authAction!authAdd.action");
        ...
        auth4_4.setCurl("/authAction!add.action");
        ...
        auth4_5.setCurl("/authAction!authEdit.action");
        ...
        auth4_6.setCurl("/authAction!edit.action");
        ...
        auth4_7.setCurl("/authAction!delete.action");
    ...
    private void repairUser() {
        ...
        List<Tuser> t = userDao.find("from Tuser t where t.cname = ? and t.cid != ?", new Object[] {
                "admin", "0" });
        if (t != null && t.size() > 0) {
            for (Tuser u : t) {
